...
<meta name="csrf_token" content="{{ csrf_token() }}" />
    ...
    <script src="{{ URL::asset('assets/351895df35.js') }}" crossorigin="anonymous"></script>
    <link rel="preconnect" href="https://fonts.gstatic.com/">
    <link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;600;700;800&amp;display=swap" rel="stylesheet">
    <!-- carousoul css -->
    <!-- Owl Stylesheets -->
    <link rel="stylesheet" href="{{ URL::asset('assets/carousel/owlcarousel/assets/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('assets/carousel/owlcarousel/assets/owl.theme.default.min.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('assets/carousel/css/animate.css') }}">
    ...
    <script type="text/javascript">
      var onloadCallback = function() {
        grecaptcha.render('pop_html_element', {
          'sitekey' : "6LcCDy4aAAAAAKbfWFpg8MAplnCgcWHgaj88VSiy"
        });
      };
    </script>